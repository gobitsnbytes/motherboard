...
description: Official Code of Conduct for GOBITSNBYTES FOUNDATION (bits&bytes™). Standards of behaviour and interpersonal conduct between team members, volunteers, and participants. Strict rules prohibiting harassment, discrimination, sexual misconduct, unwanted romantic advances or relationships, bullying, and doxxing. Heightened protections for minors under POCSO and DPDP Acts. Reporting pathways, confidentiality, three-strike graduated enforcement, and rules for the Minecraft server and SparkCloud credit program.
tags: ['code-of-conduct', 'relationships', 'interpersonal-conduct', 'team-members', 'romantic-advances', 'sexual-misconduct', 'harassment', 'safeguarding', 'minor-protection', 'pocso', 'dpdp', 'reporting', 'enforcement', 'minecraft', 'sparkcloud', 'governance', 'notion-wiki']
