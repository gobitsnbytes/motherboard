...
export default function Compose({
  ...
  return (
    <section
      ...
      className="fixed inset-0 z-50 flex flex-col bg-background sm:inset-auto sm:bottom-6 sm:right-6 sm:h-[34rem] sm:w-[36rem] sm:rounded-2xl sm:border sm:border-border sm:shadow-lg"
    >
      <header className="flex min-h-14 items-center gap-2 border-b border-border px-4">
        <h2 className="text-sm font-semibold">{draft.subject || "New message"}</h2>
        <Button
          variant="neutral"
          size="sm"
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
        ...
        <textarea
          ...
          className="mt-4 min-h-56 w-full resize-y rounded-lg border border-border bg-background px-3 py-2 text-[15px] leading-7 outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-ring"
        />
      ...
      <footer className="flex min-h-16 items-center gap-2 border-t border-border px-4">
  ...
  return (
    <div className="flex items-center gap-3 border-b border-border pb-2">
      ...
      <input
        ...
        className="h-9 min-w-0 flex-1 bg-transparent text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
      />
    </div>
  );
}
