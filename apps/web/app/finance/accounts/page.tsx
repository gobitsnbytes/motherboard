  ...
  return (
    <div className="font-heading">
      <div className="mb-7 flex items-start justify-between">
        <div>
          <h1 style={{ fontSize: "22px", fontWeight: 800, color: "#120f0a", margin: 0 }}>Virtual Accounts</h1>
          <p style={{ fontSize: "12px", color: "#6b6258", marginTop: "4px" }}>Paper bank accounts — no real money attached</p>
        </div>
