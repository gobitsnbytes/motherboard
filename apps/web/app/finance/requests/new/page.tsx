...
export default function NewRequestPage() {
  ...
  return (
    <div className="mx-auto max-w-[520px] font-heading">
      <div className="mb-7">
        <Link href="/finance/requests" className="font-heading text-[11px] tracking-[0.08em] text-muted-foreground no-underline hover:text-orange">← Requests</Link>
        <h1 className="m-0 mb-1 mt-2 font-heading text-[22px] font-extrabold text-white">New Money Request</h1>
        <p className="font-base text-xs text-muted-foreground">Submit a virtual fund request for admin approval</p>
      </div>
